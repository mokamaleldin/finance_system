...
export function ExpenseFilterForm({ from, to, category, currencyCode }: ExpenseFilterFormProps) {
  ...
  return (
    <div className={`grid gap-3 lg:grid-cols-[repeat(4,minmax(160px,1fr))_auto] ${isPending ? "opacity-80" : ""}`}>
      ...
      <label className="relative">
        <span className="mb-2 block text-sm font-semibold text-ink">نوع المصروف</span>
